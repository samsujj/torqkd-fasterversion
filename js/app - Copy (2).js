...
homeControllers1.controller('tabcommon1', function($scope,$state,$cookieStore,$rootScope,$http,$timeout,$stateParams,uiGmapGoogleMapApi,ngDialog,$facebook,$modal) {
    $rootScope.viewMoreLoad = 0;
    $rootScope.viewMore = 0;
    $rootScope.offset = 0;
...
homeControllers1.controller('bannerCommon', function($scope,$state,$cookieStore,$rootScope,$http) {
    ...
    $scope.pageId = 0;
    if($state.current.name == 'groupdetail'){
        $scope.pageId = 4;
    }
    if($state.current.name == 'profile'){
        $scope.pageId = 3;
...
homeControllers1.controller('groupdetail', function($scope,$state,$cookieStore,$http,$rootScope,ngDialog,$stateParams,$sce,Upload,$timeout,$modal) {
    $scope.userId = 0;
